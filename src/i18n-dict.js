...
export const DICT = {
  ...
  '立绘管理': 'Sprite Manager', '背景管理': 'Background Manager', '生图配置': 'Image Gen Config',
  '指定BGM': 'BGM Playlist', '自定义模块': 'Custom Modules',
  '未定义': 'Undefined', '当前角色': 'Current character', '无立绘': 'No sprite',
  '点击上传立绘': 'Click to upload sprite', '表情标签': 'Expression tags',
  '暂无已指定角色': 'No characters assigned yet', '删除角色': 'Delete character',
  '批量上传': 'Batch upload', '添加背景': 'Add background',
  '新建图包': 'New pack', '管理图包': 'Manage packs', '切换图包': 'Switch pack',
  '转移到其他图包': 'Move to another pack', '仅当前图包资源': 'Current pack assets only',
  ...
  '导入资源': 'Import assets', '导出资源': 'Export assets',
  '本地压缩包导入': 'Import local zip', '远程压缩包导入': 'Import remote zip',
  '从GitHub导入': 'Import from GitHub', '导入远程链接JSON': 'Import remote JSON link',
  '导出本地压缩包': 'Export local zip', '导出GitHub资源包': 'Export GitHub asset pack',
  '导出打包角色卡(JSON)': 'Export bundled character card (JSON)', '导入 JSON': 'Import JSON',

  // --- image gen config ---
  '背景图来源': 'Background source', '关闭': 'Off',
  'ComfyUI 文生图': 'ComfyUI text-to-image', 'API 地址': 'API URL', '测试连接': 'Test connection',
  '工作流管理 (.json)': 'Workflow manager (.json)', '暂无导入的工作流': 'No workflows imported',
  '默认角色 Workflow': 'Default character workflow', '默认背景 Workflow': 'Default background workflow',
  '默认 Checkpoint 模型': 'Default checkpoint model', '(加载中...)': '(Loading...)',
  '内置 SDXL Turbo': 'Built-in SDXL Turbo', '负面提示词': 'Negative prompt',
  '刷新模型列表': 'Refresh model list', '点击刷新获取模型列表': 'Click refresh to fetch the model list',
  '默认提示词前缀': 'Default prompt prefix', '默认提示词后缀': 'Default prompt suffix',
  '大香蕉': 'Big Banana', '大香蕉生图模块': 'Big Banana image-gen module',
  'NovelAI 生图': 'NovelAI image gen', 'Wallhaven 壁纸搜索': 'Wallhaven wallpaper search',
  '反代 API 地址': 'Proxy API URL', '反代 API Key': 'Proxy API Key', 'API Key（可选）': 'API Key (optional)',
  '留空使用公开 API': 'Leave blank for the public API', '手机或 AI 官网用': 'For mobile or the AI vendor site',
  ...
  '自动保存到背景库': 'Auto-save to background library', '保存到背景库': 'Save to background library',
  '手动生成背景': 'Generate background manually',
  '场景名称（如：教室、森林）': 'Scene name (e.g. classroom, forest)',
  '自定义提示词（可选）': 'Custom prompt (optional)', '生成预览：': 'Preview:',
  '生图COT自定义': 'Image-gen COT custom rules', '可填写额外规则': 'Optional extra rules',
  '图片尺寸': 'Image size', '图片生成模型': 'Image model', '生成图片比例': 'Image aspect ratio',
  '选择生成CG图片的比例': 'Aspect ratio for generated CGs', 'CG模式': 'CG mode',
  ...
  // --- wallhaven search ---
  '人物写真': 'People', '动漫漫画': 'Anime/Manga', '综合壁纸': 'General',
  'SFW (安全)': 'SFW (Safe)', 'Sketchy (略敏感)': 'Sketchy',
  '安全级别': 'Safety level', '图片分类': 'Categories', '自定义标签': 'Custom tags',
  '多个标签用逗号分隔': 'Separate tags with commas', '例如: cosplay, landscape, 4k': 'e.g. cosplay, landscape, 4k',
  '最新上传': 'Latest', '浏览量': 'Views', '收藏量': 'Favorites', '相关度': 'Relevance',
  '随机': 'Random', '排序方式': 'Sort by', '排行榜': 'Toplist', '排行榜时间范围': 'Toplist range',
  '1天': '1 day', '3天': '3 days', '1周': '1 week', '1个月': '1 month',
  '3个月': '3 months', '6个月': '6 months', '1年': '1 year',

  // --- resolution / ratio options ---
  '1024 x 1024 (正方形)': '1024 x 1024 (Square)', '1216 x 832 (横屏 3:2)': '1216 x 832 (Landscape 3:2)',
  '832 x 1216 (竖屏 2:3)': '832 x 1216 (Portrait 2:3)', '1472 x 704 (宽银幕)': '1472 x 704 (Widescreen)',
  '704 x 1472 (超竖屏)': '704 x 1472 (Extra tall)',
  '16:9 (横屏)': '16:9 (Landscape)', '21:9 (宽银幕)': '21:9 (Widescreen)', '2:3 (竖屏)': '2:3 (Portrait)',
  '3:2 (横屏)': '3:2 (Landscape)', '3:4 (竖屏)': '3:4 (Portrait)', '4:3 (横屏)': '4:3 (Landscape)',
  '9:16 (竖屏)': '9:16 (Portrait)',

  // --- BGM playlist tab ---
  '指定BGM歌单（注入到COT规则）': 'BGM playlist (injected into COT rules)', '保存歌单': 'Save playlist',
  '说明：': 'Notes:',
  ...
  '未知地点': 'Unknown location', '当前地点': 'Current location', '当前时间': 'Current time',
  '切换全屏': 'Toggle fullscreen',
  '空格键 -> 下一句': 'Space → Next', '回车键 -> 下一句': 'Enter → Next',
  'Ctrl长按 -> 快进': 'Hold Ctrl → Fast-forward', '按住快进 (Ctrl)': 'Hold to fast-forward (Ctrl)',
  'Galgame界面插件 设置': 'Galgame UI Plugin Settings', '正在打开设置...': 'Opening settings...',
  '退出 Galgame 模式': 'Exit Galgame Mode', 'Galgame格式规范已更新': 'Galgame format spec updated',
  '当前版本': 'Current version', '查看教程及文档': 'Docs & tutorials',
  ...
  '确认': 'Confirm', '取消': 'Cancel', '打开': 'Open', '禁用': 'Disable', '帮助': 'Help',
  '更多操作': 'More actions', '更新': 'Update', '全部': 'All', '全部类型': 'All types',
  '显示/隐藏': 'Show/Hide', '显示/隐藏立绘': 'Show/Hide sprites', '重新生成': 'Regenerate',
  '查看历史': 'View history', '播放列表': 'Playlist', '播放器': 'Player',
