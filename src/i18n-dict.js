...
export const DICT = {
  ...
  // --- ambiance themes (X暮) ---
  '薄暮': 'Twilight', '鎏暮': 'Gilded Dusk', '晓暮': 'Dawn Dusk', '绯暮': 'Crimson Dusk',
  '霓暮': 'Neon Dusk', '澄暮': 'Clear Dusk', '森暮': 'Forest Dusk', '梦暮': 'Dream Dusk', '电暮': 'Electric Dusk',
  // --- TTS voice descriptors (separate literals from the names; names stay as voice IDs) ---
  '温柔少女(免费)': 'Gentle girl (free)', '沉稳男声(免费)': 'Steady male voice (free)',
  '清冷女声(免费)': 'Cool female voice (free)', '成熟御姐(免费)': 'Mature lady (free)',
  '元气少女(免费)': 'Energetic girl (free)', '甜美声线(免费)': 'Sweet voice (free)',
  '邻家女孩(免费)': 'Girl next door (free)', '活泼萝莉(免费)': 'Lively loli (free)',
  '儒雅公子(免费)': 'Refined gentleman (free)', '阳光少年(免费)': 'Sunny boy (free)',
  '磁性低音(免费)': 'Magnetic bass (free)',
  // --- popup (弹窗) settings labels (the <弹窗一/二> tags themselves stay Chinese) ---
  '弹窗一图标': 'Popup 1 icon', '弹窗二图标': 'Popup 2 icon',
