...
```js
import 'https://cdn.jsdelivr.net/gh/KritBlade/galgame-companion@v0.9.4/dist/galgame-companion.dist.js'
```

Add AFTER the galgame script entry. `@v0.9.4` pins a release tag — bump it to update.
