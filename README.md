...
```js
import 'https://cdn.jsdelivr.net/gh/KritBlade/galgame-companion@v0.9.2/dist/galgame-companion.dist.js'
```

Add AFTER the galgame script entry. `@v0.9.2` pins a release tag — bump it to update.
